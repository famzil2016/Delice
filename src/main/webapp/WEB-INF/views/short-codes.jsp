...
<body>
	...
	<div class="typo">
		<div class="container">
			<h1 class="title wow fadeInLeftBig" data-wow-duration="1000ms"
				data-wow-delay="300ms">Short Codes</h1>
			<div class="grid_3 grid_4 wow fadeInUp" data-wow-duration="1000ms"
			...
			<div class="grid_3 grid_5 wow fadeInUp" data-wow-duration="1000ms"
				data-wow-delay="300ms">
				<h3>Buttons</h3>
				<h1>
				...
				<div class="col-md-6">
					<ul class="pagination pagination-lg">
						<li class="disabled"><a href="#"><i
								class="fa fa-angle-left">&laquo;</i></a></li>
			...
			<h3 class="bars wow fadeInUp" data-wow-duration="1000ms"
				data-wow-delay="300ms">Unordered List</h3>
			<ul class="list-group wow fadeInUp" data-wow-duration="1000ms"
				data-wow-delay="300ms">
			...
			<h3 class="bars wow fadeInUp" data-wow-duration="1000ms"
				data-wow-delay="300ms">Ordered List</h3>
			<ol class="wow fadeInUp" data-wow-duration="1000ms"
				data-wow-delay="300ms">
			...
			<h3 class="bars wow fadeInUp" data-wow-duration="1000ms"
				data-wow-delay="300ms">Forms</h3>
			<div class="input-group wow fadeInUp" data-wow-duration="1000ms"
				data-wow-delay="300ms">
			...
			<div class="input-group input-group-sm wow fadeInUp"
				data-wow-duration="1000ms" data-wow-delay="300ms">
			...
			<!-- /.row -->
			<div class="page-header wow fadeInUp" data-wow-duration="1000ms"
				data-wow-delay="300ms">
				<h3 class="bars">Tables</h3>
			</div>
			<h2 class="typoh2 wow fadeInUp" data-wow-duration="1000ms"
				data-wow-delay="300ms">Default styles</h2>
			...
			<div class="bs-docs-example wow fadeInUp" data-wow-duration="1000ms"
				data-wow-delay="300ms">
				<table class="table">
					<thead>
						<tr>
			...
			<p class="wow fadeInUp" data-wow-duration="1000ms"
				data-wow-delay="300ms">Add borders and rounded corners to the
				table.</p>
			<div class="bs-docs-example wow fadeInUp" data-wow-duration="1000ms"
				data-wow-delay="300ms">
				<table class="table table-bordered">
