		...
		<div class="footer-grids">
			...
			<div class="col-md-3 footer-grid wow fadeInUp"
				...
				<ul>
					...
					<li><a href="#">Goûters</a></li>
					<li><a href="#">Marcorons</a></li>
					<li><a href="#">Bonbons de chocolat</a></li>
					<li><a href="#">Pièces montées</a></li>
					<li><a href="#">Tablettes</a></li>
					<li><a href="#">Cocktails et buffets</a></li>
					<li><a href="#">Bouchées</a></li>
				</ul>
			</div>
			<div class="col-md-3 footer-grid wow fadeInUp"
				data-wow-duration="1000ms" data-wow-delay="300ms">
			...
			<div class="col-md-3 footer-grid wow fadeInUp"
				...
				<div class="footer-grd">
					<a href="#"><img src="resources/images/7.jpg" class="img-responsive"
						alt=" " /></a>
				</div>
				<div class="footer-grd">
					<a href="#"><img src="resources/images/8.jpg" class="img-responsive"
						alt=" " /></a>
				</div>
				<div class="footer-grd">
					<a href="#"><img src="resources/images/7.jpg" class="img-responsive"
